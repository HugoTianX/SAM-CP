...
from .BertForMLM4Contra_add_sim import BertForMaskedLM
...
# Train model
trainer.train()
trainer.save_model("bert-sim-train-loss-cos-sim-last")
tokenizer.save_pretrained("bert-sim-train-loss-cos-sim-last")
